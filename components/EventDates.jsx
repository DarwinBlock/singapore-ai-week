	...
	return (
		<div className="slider-container">
			<div className="slider-header">
				<div className="tab">
					<button
						onClick={() => setSelectedDate("alldates")}
						className={"tablinks " + (selectedDate === "alldates" ? "active" : "")}
						data-but_id="alldates"
					>
						All Dates
					</button>
					{genDates.map((item) => {
						return (
							<button
								...
								key={`${item.key}`}
								className={"tablinks " + (selectedDate === item.key ? "active" : "")}
								data-but_id={item.key}
							>
								{item.val}
							</button>
						);
